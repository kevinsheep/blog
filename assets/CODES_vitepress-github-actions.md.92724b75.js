import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.9630cdb1.js";const m=JSON.parse('{"title":"自动部署博客","description":"","frontmatter":{"title":"自动部署博客","updateTime":"2023/01/28","tags":"CD"},"headers":[],"relativePath":"CODES/vitepress-github-actions.md","filePath":"CODES/vitepress-github-actions.md","lastUpdated":1702135941000}'),l={name:"CODES/vitepress-github-actions.md"},e=p(`<p>一般文档，写到构建完成就该差不多了。可 <code>VitePress</code> 相当认真地，写了在好几种平台上的部署方案。详见 <a href="https://vitepress.vuejs.org/guide/deploying" target="_blank" rel="noreferrer">Deploying</a>。</p><h2 id="github" tabindex="-1">Github <a class="header-anchor" href="#github" aria-label="Permalink to &quot;Github&quot;">​</a></h2><p>使用 GitHub Actions 发布的体验很舒服。</p><p>你只需要配置好 GitHub Actions，每次 Git Push 后，坐等几分钟就看到自己的博客自动更新了，当然，前提是你已本地测试完善没有构建错误，也没有文章死链等。</p><p>VitePress 官方文档连<a href="https://vitepress.vuejs.org/guide/deploy" target="_blank" rel="noreferrer">使用 GitHub Actions 部署的方法</a>都有教，可谓相当贴心了。</p><p>官方文档的 yml 配置是基于 <code>yarn</code> 打包的，这里分享一下我基于 <code>pnmp</code> 打包的配置文件：</p><div class="language-yaml vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># Simple workflow for deploying static content to GitHub Pages</span></span>
